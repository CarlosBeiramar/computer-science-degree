...
public class TrazAqui implements Serializable{
    ...
    public void setencaceites(Map<String, Encomenda> encaceites)
    {
        ...
        private static void addEncomenda(TrazAqui trazAqui, String string) {
            ...
            trazAqui.addEnc(enc);
                User u = trazAqui.utilizadores.get(fields[1]);
                User lu = trazAqui.utilizadores.get(fields[2]);
                if (u != null) {
                    Cliente c = (Cliente) u;
                    c.addEnc(enc);
     ...
     */
        public static TrazAqui recoverState() {
            TrazAqui t = null;
                try {
                    FileInputStream fis = new FileInputStream("teste.tmp");
        ...
        public void saveState() {
            try {
                FileOutputStream fos = new FileOutputStream("teste.tmp");
         ...
         *
         * o primeiro for percorre a lista de utilizadores e para cada utilizador vê as encomendas aceitas e coloca no seu historico
         * caso nao haja nada para adicionar no cliente simplestmentes adiciona o cliente na hashMap.
         *
         * o segundo for percorre a lista de utilizadores e verifica se o utilizador é uma loja, caso seja percorre o hashmap das encomendas
         * verifica em cada encomenda se a msm foi feita na loja guardada, caso tenha sido adiciona a encomenda à fila de espera da loja.
         * e dps da insere a loja novamente na hashmap atualizada.
        */
